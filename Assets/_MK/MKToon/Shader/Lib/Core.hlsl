...
//////////////////////////////////////////////////////
	...
	#define MK_TOON_CORE
		...
		#ifndef GetMeshRenderingLightLayer
			#define GetMeshRenderingLightLayer GetMeshRenderingLayer
		#endif
		#if defined(_AdditionalLightsDirectionalCount) && !defined(URP_FP_DIRECTIONAL_LIGHTS_COUNT)
			#define URP_FP_DIRECTIONAL_LIGHTS_COUNT _AdditionalLightsDirectionalCount
		#endif
