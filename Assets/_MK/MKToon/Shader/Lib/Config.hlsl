...
//////////////////////////////////////////////////////
	...
	*/
	...
	#if	defined(USE_CLUSTERED_LIGHTING) || defined(USE_CLUSTER_LIGHT_LOOP) || defined(USE_FORWARD_PLUS) || defined(MK_REFRACTION) || defined(MK_SOFT_FADE) || defined(MK_CAMERA_FADE) || defined(MK_NORMALIZED_SCREEN_UV) || defined(MK_SCREEN_SPACE_OCCLUSION)
		#ifndef MK_SCREEN_UV
			#define MK_SCREEN_UV
		#endif
	#endif
